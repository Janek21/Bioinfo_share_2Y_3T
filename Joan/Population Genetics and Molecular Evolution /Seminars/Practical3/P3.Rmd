...
drift.selection(0.005, 1000, c(1,1,1-s), nrep = 20)
...
```{r answer-exercise-5}
observed_children <- c(189, 89, 9)
observed_adults <- c(400, 249, 5)

total_children <- sum(observed_children)
total_adults <- sum(observed_adults)
...
| Relative survival     |     |     |    |
| Relative fitness      |     |     |    |
| Selective coefficients (s<sub>1</sub> and s<sub>2</sub>)  |     |     |    |

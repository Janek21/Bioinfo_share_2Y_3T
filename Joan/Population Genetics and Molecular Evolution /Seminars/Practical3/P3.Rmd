...
```{r answer-exercise-1}
s=0.05
selection(0.005,w=c(1,1,1-s), 5000)
selection(0.005,w=c(1,1-s,1-s), 5000)
...
```{r answer-exercise-2}
s=0.16
selection(0.005,w=c(1,1,1-s), 52, show="p")
...
#Yes, if the environmental condition is exactly reverse (creating the conditions previous to the change) making the change less beneficial than the one that already existed, with generations the population would reverse the frequencies into the past ones.
...
|:----------------:|:--------------------:|:---------------:|:--------------------:|
| p0=0.005, Ne=100 |          13            |        0         |           7           |


```{r answer-exercise-4}
s=0.16
drift.selection(0.005, 100, c(1,1,1-s), nrep = 20)
drift.selection(0.005, 2000, c(1,1,1-s), nrep = 20)
...
children
#Here we can see that the chi value is lower than the critical value, therefor we reject the null, meaning that it follows HWE

adults <- test_HWE(400, 249, 5)
adults
#Here we can see that the chi value is higher than the critical value, therefor we accept the null, meaning that it doesn't follow HWE
...
| Number of children    | 189 | 89  | 9  |
| Number of adult       | 400 | 249 | 5  | 
| Frequency in children | 0.6585366    |  0.3101045   |  0.03135889  |
| Frequency in adults   | 0.6116208    |  0.3807339   |  0.00764526  |
| Relative survival     | 0.9287    |  1.2277   |  0.2438  |
| Relative fitness      |  0.7564   |   1  |  0.1986  |
| Selective coefficients (s<sub>1</sub> and s<sub>2</sub>)  | 0.2436    |  -   |  0.8014  |


```{r answer-exercise-6}
#Looking at the table we can see how the heterozygote is the one with the most survival rate by a relatively strong margin
```
...
# I have learned how to simulate populations in both natural selection and genetic drift situations, modify them according what I need and interpret the results and graphs obtained.
# Also I have learned more about how polymorphism works
#
